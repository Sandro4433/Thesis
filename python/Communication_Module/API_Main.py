    ...
    messages: List[Dict[str, str]] = [
        {
            ...
            "content": (
                ...
                "- User says N new parts of a colour were added, but fewer than N "
                "new detections of that colour exist in the scan. "
                "Example: user says 'I added two blue parts' but only one "
                "new blue detection is present — flag this: 'I only see 1 "
                "new blue detection, but you said 2 were added. Can you "
                "clarify?'\n"
