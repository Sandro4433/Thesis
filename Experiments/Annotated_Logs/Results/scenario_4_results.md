# Scenario 4 — Full End-to-End Reconfiguration Cycle
...
## Turn-Type Breakdown by Phase

| Phase | Description | Total | USR | AST | USR-INST | USR-CONF | USR-CLAR | USR-DONE | AST-OPEN | AST-PROP | AST-CLAR | AST-VIOL | Config Correct |
|-------|-------------|-------|-----|-----|----------|----------|----------|----------|----------|----------|----------|----------|----------------|
| **Total** | — | 66 | 31 | 35 | 8 | 14 | 3 | 6 | 12 | 11 | 5 | 4 | Y |
